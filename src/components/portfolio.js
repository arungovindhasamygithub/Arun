                ...
                <div className="col-12 filters-group-wrap wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                    <div className="filters-group">
                        <ul className="portfolioFilter list-inline mb-0 filter-options text-center">
                            ...
                            <li className={`${selectedCategory === 'branding' ? 'active' : '' } list-inline-item categories-name border text-dark px-3 rounded`} onClick={() =>matchCategory('Next Js')}>Next Js</li>
                            <li className={`${selectedCategory === 'designing' ? 'active' : '' } list-inline-item categories-name border text-dark px-3 rounded`} onClick={() =>matchCategory('React Js')}>React Js</li>
                            <li className={`${selectedCategory === 'photography' ? 'active' : '' } list-inline-item categories-name border text-dark px-3 rounded`} onClick={() =>matchCategory('Graphic Designer')}>Graphic Designer</li>
                            <li className={`${selectedCategory === 'development' ? 'active' : '' } list-inline-item categories-name border text-dark px-3 rounded`} onClick={() =>matchCategory('Photography')}>Photography</li>
                        </ul>
                    </div>
                </div>
            </div>
