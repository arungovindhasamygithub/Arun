...
import heroImg1 from '../assets/images/home/hero.png'
...
export default function IndexModern(){
    ...
    return(
        ...
        <section className="bg-modern bg-light bg-animation-right" id="home">
                    ...
                    <div className="col-lg-7 col-md-7">
                        <div className="title-heading mt-5">
                            ...
                            <div className="mt-4 pt-2">
                                <Link to="" className="btn btn-primary rounded mb-2 me-2">Hire me</Link>
                                <Link to="" className="btn btn-outline-primary rounded mb-2">Download CV <FiDownload className="fea icon-sm"/></Link>
                            </div>
                        </div>
                    </div>
            ...
            <Link1 to="about" data-scroll-nav="1" className="mouse-icon d-none d-md-inline-block rounded-pill bg-transparent mouse-down">
